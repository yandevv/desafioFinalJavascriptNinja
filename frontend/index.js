  ...
  function app() {
    ...
    function init() {
      async function submitHandler(e) {
        ...
        fetch('http://localhost:3000/car').then((response) => response.json()).then((response) => addLastAddedCar(response[response.length - 1]));
      }
    ...
    return {
      "init": init,
      "uploadCar": uploadCar,
      "addLastAddedCar": addLastAddedCar,
